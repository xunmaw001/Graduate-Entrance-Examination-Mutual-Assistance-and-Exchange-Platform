<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="课程名称" prop="kechengmingcheng">
					<el-input v-model="ruleForm.kechengmingcheng" placeholder="课程名称" clearable  :readonly="ro.kechengmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="课程名称" prop="kechengmingcheng">
					<el-input v-model="ruleForm.kechengmingcheng" placeholder="课程名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="课程分类" prop="kechengfenlei">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="课程分类" prop="kechengfenlei">
					<el-input v-model="ruleForm.kechengfenlei"
						placeholder="课程分类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.kechengfengmian" label="课程封面" prop="kechengfengmian">
					<file-upload
						tip="点击上传课程封面"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.kechengfengmian" label="课程封面" prop="kechengfengmian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.kechengshipin" label="课程视频" prop="kechengshipin">
					<file-upload
						tip="点击上传课程视频"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.kechengshipin" label="课程视频" prop="kechengshipin">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"30px","background":"#93C7B3","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.kechengshipin)">预览</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.kechengshipin" label="课程视频" prop="kechengshipin">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="开课时间" prop="kaikeshijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.kaikeshijian" 
						type="date"
						:readonly="ro.kaikeshijian"
						placeholder="开课时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.kaikeshijian" label="开课时间" prop="kaikeshijian">
					<el-input v-model="ruleForm.kaikeshijian" placeholder="开课时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="课程内容" prop="kechengneirong">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.kechengneirong" label="课程内容" prop="kechengneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.kechengneirong"></span>
                </el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.kaikeshijian = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
            ...
            this.kechengfenleiOptions = "公开课,一对一".split(',')
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.kechengneirong = this.ruleForm.kechengneirong.replace(reg,'../../../phpl3663/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
